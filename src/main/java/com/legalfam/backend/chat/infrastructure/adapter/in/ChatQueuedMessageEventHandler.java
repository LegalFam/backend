...
import com.legalfam.backend.chat.infrastructure.adapter.out.N8nWebhookClient;
...
public class ChatQueuedMessageEventHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(ChatQueuedMessageEventHandler.class);
    ...
    public ChatQueuedMessageEventHandler(
    ...
    private void persistAndDispatchFailure(
        ...
        chatSseEmitterRegistry.dispatchAssistantError(dispatch.userId(), dispatch.chatSessionId(), dispatch.event());
    }
