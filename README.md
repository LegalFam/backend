...
curl -X POST http://localhost:8080/api/v1/chat \
  -H "Authorization: Bearer <your_access_token>" \
  -H "Content-Type: application/json" \
  -d '{"message":"Summarize this user message and return the next legal step."}'
```
...
```json
{
  ...
  "messageId": "e6f3b5e6-24eb-49b7-8ee5-860eaab9454c",
  "message": "Here is the response generated by the workflow.",
  "citations": [
    {
      "sourceTitle": "Codigo_Civil_Peru.pdf",
      "sourceSnippet": "Artículo 472.- Se entiende por alimentos...",
